...
echo "Creating Quay Organization 'demo-imagepolicies'"
echo "========================================="
echo ""
...
echo ""
echo "Creating organization 'demo-imagepolicies'..."
RESPONSE=$(curl -k -X POST \
    -H "Authorization: Bearer $QUAY_ADMIN_TOKEN" \
    -H "Content-Type: application/json" \
    -d '{"name": "demo-imagepolicies", "email": ""}' \
...
if [ "$HTTP_CODE" -eq 201 ] || [ "$HTTP_CODE" -eq 200 ]; then
    ...
    echo "Success!"
    echo "================================"
    echo "Organization 'demo-imagepolicies' created successfully"
    echo "Quay URL: $QUAY_URL"
    echo "Organization URL: $QUAY_URL/organization/demo-imagepolicies"
    echo "================================"
    ...
    echo "================================"
    echo "Organization 'demo-imagepolicies' already exists in Quay"
    echo "Organization URL: $QUAY_URL/organization/demo-imagepolicies"
    echo "================================"
else
    echo ""
